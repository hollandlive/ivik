 ...
 <!--The example of this working file you can see at my web-site http://arthem.info/bj/ -->
<html lang="en">
<head>
    <meta charset="utf-8">
...
if (empty($_POST)) //if there is no any button pressed
{
    ...
    $handstr = serialize($hand);//using of serialize function to pass the arrays http://freeonlinetools24.com/serialize
    $deckstr= serialize($deck);//hand, deck and dealer 
    $dealerstr= serialize($dealer);//to PHP as strings
...
if ($_POST['submit'] == 'hit me')
{
	...
	//var_dump ($deck); // $deck is again an array
    $hand[] = array_shift($deck);
    $dealerstr = $_POST['dealerstr'];
    $handstr = serialize($hand);
    $deckstr= serialize($deck);}
	
/* I use printf function to print up results
* htmlspecialchars ($handstr, ENT_QUOTES) - Converts double and single quotes
*/
printf(
...
<div class="col-md-4">
<h3>The Sponsor:)</h3>
<p class="text-left"><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- large-skyscryper -->
<ins class="adsbygoogle"
     style="display:inline-block;width:300px;height:600px"
     data-ad-client="ca-pub-9193385610386562"
     data-ad-slot="4310583336"></ins>
<script>
